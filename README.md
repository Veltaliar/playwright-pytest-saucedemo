# Playwright Python SauceDemo Testing Suite ![Python](https://img.shields.io/badge/python-3.11%2B-blue) ![Lint](https://github.com/Veltaliar/playwright-pytest-saucedemo/actions/workflows/lint.yml/badge.svg?branch=main) ![Tests](https://github.com/Veltaliar/playwright-pytest-saucedemo/actions/workflows/playwright-docker.yml/badge.svg?branch=main)
